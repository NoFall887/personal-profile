...
import React, { ElementType, forwardRef, ReactNode, useCallback, useRef } from "react";
...
const GlowBox = forwardRef(
    <T extends ElementType = "div">(
        { as, children, className, tilt = true, ...props }: GlowBoxProps<T>,
        ref
    ) => {
